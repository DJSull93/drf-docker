...
def admin_user(
    ...
    """A Django mywork user.

    This uses an existing user with username "mywork", or creates a new one with
    password "password".
    """
    UserModel = django_user_model
    username_field = django_username_field
    username = "mywork@example.com" if username_field == "email" else "mywork"
    ...
    try:
        ...
        if "email" in UserModel.REQUIRED_FIELDS:
            user_data["email"] = "mywork@example.com"
...
def admin_client(
    ...
    """A Django test client logged in as an mywork user."""
    from django.test.client import Client
