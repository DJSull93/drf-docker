...
class AdminUserObjectPermissionsForm(UserObjectPermissionsForm):
    ...
    ``django.contrib.mywork.widgets.FilteredSelectMultiple`` widget.
    """
...
class GuardedModelAdminMixin:
    """
    Serves as a helper for custom subclassing ``mywork.ModelAdmin``.
    """
    change_form_template = \
        'mywork/guardian/model/change_form.html'
    obj_perms_manage_template = \
        'mywork/guardian/model/obj_perms_manage.html'
    obj_perms_manage_user_template = \
        'mywork/guardian/model/obj_perms_manage_user.html'
    obj_perms_manage_group_template = \
        'mywork/guardian/model/obj_perms_manage_group.html'
    ...
    def get_urls(self):
        """
        Extends standard mywork model urls with the following:
    ...
    def get_obj_perms_base_context(self, request, obj):
        """
        Returns context dictionary with common mywork and object permissions
    ...
    def get_obj_perms_manage_template(self):
        """
        Returns main object permissions mywork template.  May be overridden if
        need to change it dynamically.

        .. note::
           If ``INSTALLED_APPS`` contains ``grappelli`` this function would
           return ``"mywork/guardian/grappelli/obj_perms_manage.html"``.

        """
        if 'grappelli' in settings.INSTALLED_APPS:
            return 'mywork/guardian/contrib/grappelli/obj_perms_manage.html'
    ...
    def get_obj_perms_manage_user_template(self):
        """
        Returns object permissions for user mywork template.  May be overridden
        if need to change it dynamically.

        .. note::
           If ``INSTALLED_APPS`` contains ``grappelli`` this function would
           return ``"mywork/guardian/grappelli/obj_perms_manage_user.html"``.

        """
        if 'grappelli' in settings.INSTALLED_APPS:
            return 'mywork/guardian/contrib/grappelli/obj_perms_manage_user.html'
    ...
    def get_obj_perms_manage_group_template(self):
        """
        Returns object permissions for group mywork template.  May be overridden
        if need to change it dynamically.

        .. note::
           If ``INSTALLED_APPS`` contains ``grappelli`` this function would
           return ``"mywork/guardian/grappelli/obj_perms_manage_group.html"``.

        """
        if 'grappelli' in settings.INSTALLED_APPS:
            return 'mywork/guardian/contrib/grappelli/obj_perms_manage_group.html'
...
class GuardedModelAdmin(GuardedModelAdminMixin, admin.ModelAdmin):
    """
    Extends ``django.contrib.mywork.ModelAdmin`` class. Provides some extra
    views for object permissions management at mywork panel. It also changes
    default ``change_form_template`` option to
    ``'mywork/guardian/model/change_form.html'`` which is required for proper
    ...
    **Extra options**
    ...
    ``GuardedModelAdmin.obj_perms_manage_template``
        ...
        *Default*: ``mywork/guardian/model/obj_perms_manage.html``

    ``GuardedModelAdmin.obj_perms_manage_user_template``

        *Default*: ``mywork/guardian/model/obj_perms_manage_user.html``

    ``GuardedModelAdmin.obj_perms_manage_group_template``

        *Default*: ``mywork/guardian/model/obj_perms_manage_group.html``
    ...
    **Usage example**
    ...
    Just use :mywork:`GuardedModelAdmin` instead of
    ``django.contrib.mywork.ModelAdmin``.

    .. code-block:: python

        from django.contrib import mywork
        from guardian.mywork import GuardedModelAdmin
        from myapp.models import Author

        class AuthorAdmin(GuardedModelAdmin):
            pass

        mywork.site.register(Author, AuthorAdmin)
